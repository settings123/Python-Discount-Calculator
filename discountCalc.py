...
# Canvas
canvas = Canvas(window,bg="#FFFFFF",height=578,width=869,bd=0,highlightthickness=0,relief="ridge")
...
# Text
canvas.create_text(169.0,153.0,anchor="nw",text="Whats the Discount Bruh?",fill="#2E2E2E",font=("ReemKufi Regular",48 * -1))
...
calculateButton = Button(image=calculateButtonImage,borderwidth=0,highlightthickness=0,command=calculateDiscountedPrice,relief="flat")
calculateButton.place(x=162.0,y=422.0,width=180.0,height=34.0)

# Text
canvas.create_text(169.0,153.0,anchor="nw",text="Whats the Discount Bruh?",fill="#2E2E2E",font=("ReemKufi Regular",48 * -1))
canvas.create_text(412.0,527.0,anchor="nw",text="\nKoding With Khanh",fill="#EEE9E9",font=("ReemKufi Regular", 13 * -1))
canvas.create_text(108.0,341.0,anchor="nw",text="Discount (%): ",fill="#575555",font=("Roboto", 24 * -1))
canvas.create_text(108.0,293.0,anchor="nw",text="Price ($):",fill="#575454",font=("Roboto", 24 * -1))
canvas.create_text(546.0,287.0,anchor="nw",text="Discounted Price ($): ",fill="#575555",font=("Roboto", 24 * -1))
